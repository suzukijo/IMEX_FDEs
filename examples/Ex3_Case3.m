...
%% IMEX Solver %%
if imex_type == 1
    [t, y11, ctime] = Fast_FAMMI_E_Correction_rev2_new(@fun_f1,t0,T, ...
        y0,N,alpha,lambdamrho,Mlu,sigma1,Mf,sigma2,Mu,sigma3,Me,sigma4, ...
        tol,epsil);

elseif imex_type == 2
    [t, y11, ctime] = Fast_FAMMII_E_Correction_rev2(@fun_f1,t0,T,y0, ...
        N,alpha,lambdamrho,Mlu,sigma1,Mf,sigma2,Mu,sigma3,Me,sigma4, ...
        tol,epsil);
end
